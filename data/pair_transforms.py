...
class Resize(transforms.Resize):
    ...
    def forward(self, img, tgt, interpolation1=InterpolationMode.LANCZOS, interpolation2=InterpolationMode.NEAREST):
        """
        Args:
        ...
        return F.resize(img, (self.size,self.size), InterpolationMode.LANCZOS),F.resize(tgt, (self.size,self.size), InterpolationMode.NEAREST)
